...
// Serves as placeholder for where to put a eventbus interface to interact with another service over the network.

// A eventbus for another service only requires and returns domain-specific data.
